...
proto.calculator.SumRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    secondNmber: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
...
/**
 * optional int32 second_nmber = 2;
 * @return {number}
 */
proto.calculator.SumRequest.prototype.getSecondNmber = function() {
 ...
 * @return {!proto.calculator.SumRequest} returns this
 */
proto.calculator.SumRequest.prototype.setSecondNmber = function(value) {
